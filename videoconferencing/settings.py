...
"""DATABASES = {
    'default': {
        ...
        'NAME': 'rds-videocallapp',
        'USER': 'auth',
        'PASSWORD': 'Subho123',
        'HOST': 'rds-videocallapp.cbkqq280uzs4.us-east-1.rds.amazonaws.com',  # or the hostname where your MySQL server is running
...
CSRF_TRUSTED_ORIGINS = ['https://hardly-training-tired-sc.trycloudflare.com']
